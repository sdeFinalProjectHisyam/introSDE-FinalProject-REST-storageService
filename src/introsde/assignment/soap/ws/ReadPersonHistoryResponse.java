 ...
 *       &lt;sequence>
 *         &lt;element name="healthMeasure" type="{http://ws.soap.assignment.introsde/}healthMeasureHistory" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReadPersonHistoryResponse {
    ...
    protected List<HealthMeasureHistory> healthMeasure;
     ...
     * 
     */
    public List<HealthMeasureHistory> getHealthMeasure() {
        if (healthMeasure == null) {
            healthMeasure = new ArrayList<HealthMeasureHistory>();
        }

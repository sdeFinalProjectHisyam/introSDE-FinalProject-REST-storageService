 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.soap.assignment.introsde/", wsdlLocation = "https://mighty-spire-37813.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://mighty-spire-37813.herokuapp.com/ws/people?wsdl");
